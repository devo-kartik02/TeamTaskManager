        ...
        <div className="relative z-10">
          ...
          <div className="max-w-lg mt-20">
            ...
            <p className="text-lg text-slate-400 leading-relaxed mb-10">
              Join thousands of teams who use TaskMaster to bring order to chaos, align on goals, and ship faster.
            </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-400">Join the team and start collaborating</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <select
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all outline-none text-white shadow-inner appearance-none"
                >
                  <option value="Member" className="bg-slate-800">Team Member</option>
